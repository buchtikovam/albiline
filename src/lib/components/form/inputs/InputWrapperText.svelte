	...
	<div class="w-full">
		...
		<input
			...
			class={`
				...
				h-10 disabled:bg-slate-50 disabled:cursor-not-allowed w-full border border-slate-300 rounded-md text-sm px-3 focus-visible:ring-0 focus-visible:outline-none focus-visible:border-albi-500`
			}
		>

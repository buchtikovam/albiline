...
<!--			&lt;!&ndash; page label + get addresses button &ndash;&gt;-->
...
<!--			&lt;!&ndash; page navigation buttons &ndash;&gt;-->
...
<!--			&lt;!&ndash; address detail form &ndash;&gt;-->
<!--			{#if item.type === "form"}-->
...
<!--			&lt;!&ndash; address contacts table: display all, add new, move table up/down &ndash;&gt;-->
